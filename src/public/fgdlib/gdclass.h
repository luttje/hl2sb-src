...
class GDclass
{
 public:
  ...
  //
  inline int GetVariableCount( void )
  {
    return ( m_nVariables );
  }
  ...
  inline int GetOutputCount( void )
  {
  ...
  inline bool IsSolidClass( void )
  {
    return ( m_bSolid );
  }
  inline bool IsBaseClass( void )
  {
    return ( m_bBase );
  }
  inline bool IsMoveClass( void )
  {
    return ( m_bMove );
  }
  inline bool IsKeyFrameClass( void )
  {
    return ( m_bKeyFrame );
  }
  inline bool IsPointClass( void )
  {
    return ( m_bPoint );
  }
  inline bool IsNPCClass( void )
  {
    return ( m_bNPC );
  }
  inline bool IsFilterClass( void )
  {
    return ( m_bFilter );
  }
  ...
  inline bool ShouldSnapToHalfGrid()
  {
    return m_bHalfGridSnap;
  }

  inline void SetNPCClass( bool bNPC )
  {
    m_bNPC = bNPC;
  }
  inline void SetFilterClass( bool bFilter )
  {
    m_bFilter = bFilter;
  }
  inline void SetPointClass( bool bPoint )
  {
    m_bPoint = bPoint;
  }
  inline void SetSolidClass( bool bSolid )
  {
    m_bSolid = bSolid;
  }
  inline void SetBaseClass( bool bBase )
  {
    m_bBase = bBase;
  }
  inline void SetMoveClass( bool bMove )
  {
    m_bMove = bMove;
  }
  inline void SetKeyFrameClass( bool bKeyFrame )
  {
    m_bKeyFrame = bKeyFrame;
  }

  inline const Vector &GetMins( void )
  {
    return ( m_bmins );
  }
  inline const Vector &GetMaxs( void )
  {
    return ( m_bmaxs );
  }
  ...
  inline int GetHelperCount( void )
  {
