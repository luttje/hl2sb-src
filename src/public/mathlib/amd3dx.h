...
#define InjK3DOps( dst, src, inst )                                                                                     \
  {                                                                                                                     \
    _asm _emit 0x0f _asm _emit 0x0f _asm _emit( ( _K3D_##dst & 0x3f ) << 3 ) | _K3D_##src _asm _emit _3DNowOpcode##inst \
  }

#define InjK3DMOps( dst, src, off, inst )                                                                                                         \
  {                                                                                                                                               \
    _asm _emit 0x0f _asm _emit 0x0f _asm _emit( ( ( _K3D_##dst & 0x3f ) << 3 ) | _K3D_##src | 0x40 ) _asm _emit off _asm _emit _3DNowOpcode##inst \
  }

#define InjMMXOps( dst, src, inst )                                                                     \
  {                                                                                                     \
    _asm _emit 0x0f _asm _emit _3DNowOpcode##inst _asm _emit( ( _K3D_##dst & 0x3f ) << 3 ) | _K3D_##src \
  }

#define InjMMXMOps( dst, src, off, inst )                                                                                         \
  {                                                                                                                               \
    _asm _emit 0x0f _asm _emit _3DNowOpcode##inst _asm _emit( ( ( _K3D_##dst & 0x3f ) << 3 ) | _K3D_##src | 0x40 ) _asm _emit off \
  }
...
#define PREFETCHMLONG( src, off )                                                                                                                                                                                           \
  {                                                                                                                                                                                                                         \
    _asm _emit 0x0f _asm _emit 0x0d _asm _emit( 0x80 | ( _K3D_##src & 0x07 ) ) _asm _emit( off & 0x000000ff ) _asm _emit( off & 0x0000ff00 ) >> 8 _asm _emit( off & 0x00ff0000 ) >> 16 _asm _emit( off & 0xff000000 ) >> 24 \
  }
...
#define PREFETCHWMLONG( src, off )                                                                                                                                                                                       \
  {                                                                                                                                                                                                                      \
    _asm _emit 0x0f _asm _emit 0x0d _asm _emit 0x88 | ( _K3D_##src & 0x07 ) _asm _emit( off & 0x000000ff ) _asm _emit( off & 0x0000ff00 ) >> 8 _asm _emit( off & 0x00ff0000 ) >> 16 _asm _emit( off & 0xff000000 ) >> 24 \
  }
