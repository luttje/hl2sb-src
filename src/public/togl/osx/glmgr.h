...
{
  GLint enable;
  bool operator==( const GLAlphaTestEnable_t &src ) const
  {
    return EQ( enable );
  }
};
struct GLAlphaTestFunc_t
{
  GLenum func;
  GLclampf ref;
  bool operator==( const GLAlphaTestFunc_t &src ) const
  {
...
{
  GLint enable;
  bool operator==( const GLCullFaceEnable_t &src ) const
  {
    return EQ( enable );
  }
};
...
{
  GLenum value;
  bool operator==( const GLCullFrontFace_t &src ) const
  {
    return EQ( value );
  }
};
...
{
  GLenum values[2];
  bool operator==( const GLPolygonMode_t &src ) const
  {
...
struct GLDepthBias_t
{
  GLfloat factor;
  GLfloat units;
  bool operator==( const GLDepthBias_t &src ) const
  {
...
{
  GLint enable;
  bool operator==( const GLScissorEnable_t &src ) const
  {
    return EQ( enable );
  }
};
struct GLScissorBox_t
{
  ...
  bool operator==( const GLScissorBox_t &src ) const
  {
...
{
  GLint enable;
  bool operator==( const GLAlphaToCoverageEnable_t &src ) const
  {
    return EQ( enable );
  }
};
struct GLViewportBox_t
{
  GLint x, y;
  GLsizei width, height;
  bool operator==( const GLViewportBox_t &src ) const
  {
    return EQ( x ) && EQ( y ) && EQ( width ) && EQ( height );
  }
};
...
{
  GLdouble near, far;
  bool operator==( const GLViewportDepthRange_t &src ) const
  {
    return EQ( near ) && EQ( far );
  }
};
struct GLClipPlaneEnable_t
{
  GLint enable;
  bool operator==( const GLClipPlaneEnable_t &src ) const
  {
    return EQ( enable );
  }
};
...
{
  GLfloat x, y, z, w;
  bool operator==( const GLClipPlaneEquation_t &src ) const
  {
...
{
  char r, g, b, a;
  bool operator==( const GLColorMaskSingle_t &src ) const
  {
...
{
  char r, g, b, a;
  bool operator==( const GLColorMaskMultiple_t &src ) const
  {
    return EQ( r ) && EQ( g ) && EQ( b ) && EQ( a );
  }
};
...
{
  GLint enable;
  bool operator==( const GLBlendEnable_t &src ) const
  {
    return EQ( enable );
  }
};
struct GLBlendFactor_t
{
  ...
  bool operator==( const GLBlendFactor_t &src ) const
  {
...
{
  GLenum equation;
  bool operator==( const GLBlendEquation_t &src ) const
  {
    return EQ( equation );
  }
};
...
{
  GLfloat r, g, b, a;
  bool operator==( const GLBlendColor_t &src ) const
  {
    return EQ( r ) && EQ( g ) && EQ( b ) && EQ( a );
  }
};
...
{
  GLint enable;
  bool operator==( const GLBlendEnableSRGB_t &src ) const
  {
    return EQ( enable );
  }
};
...
{
  GLint enable;
  bool operator==( const GLDepthTestEnable_t &src ) const
  {
    return EQ( enable );
  }
};
...
{
  GLenum func;
  bool operator==( const GLDepthFunc_t &src ) const
  {
    return EQ( func );
  }
};
...
{
  char mask;
  bool operator==( const GLDepthMask_t &src ) const
  {
    return EQ( mask );
  }
};
...
{
  GLint enable;
  bool operator==( const GLStencilTestEnable_t &src ) const
  {
    return EQ( enable );
  }
};
struct GLStencilFunc_t
{
  ...
  GLint ref;
  GLuint mask;
  bool operator==( const GLStencilFunc_t &src ) const
  {
...
struct GLStencilOp_t
{
  ...
  GLenum dpfail;
  GLenum dppass;
  bool operator==( const GLStencilOp_t &src ) const
  {
...
{
  GLint mask;
  bool operator==( const GLStencilWriteMask_t &src ) const
  {
    return EQ( mask );
  }
};
...
{
  GLfloat r, g, b, a;
  bool operator==( const GLClearColor_t &src ) const
  {
    return EQ( r ) && EQ( g ) && EQ( b ) && EQ( a );
  }
};
...
{
  GLdouble d;
  bool operator==( const GLClearDepth_t &src ) const
  {
    return EQ( d );
  }
};
...
{
  GLint s;
  bool operator==( const GLClearStencil_t &src ) const
  {
    return EQ( s );
  }
};
...
#define EQ( fff ) ( ( src.fff ) == ( fff ) )
  ...
  bool operator==( const GLMVertexAttributeDesc &src ) const
  {
    return EQ( m_buffer ) && EQ( m_offset ) && EQ( m_stride ) && EQ( m_datatype ) && EQ( m_normalized ) && EQ( m_datasize );
  }
#undef EQ
