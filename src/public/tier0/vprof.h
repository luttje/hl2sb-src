...
class DBG_CLASS CVProfNode
{
 ...
 public:
  ...
  {
    m_iClientData = iClientData;
  }
  int GetClientData() const
  {
    return m_iClientData;
  }
...
class DBG_CLASS CVProfile
{
 public:
  ...
  unsigned GetTargetThreadId()
  {
    return m_TargetThreadId;
  }
  bool InTargetThread()
  {
    return ( m_TargetThreadId == ThreadGetCurrentId() );
  }
...
#define MAX_GROUP_STACK_DEPTH 1024
  ...
  {
    m_bPMEEnabled = bEnable;
  }

#ifndef _X360
  bool UsePME( void )
  {
    return ( m_bPMEInit && m_bPMEEnabled );
  }
#else
  bool UsePME( void )
  {
    return ( CPMCData::IsInitialized() && m_bPMEEnabled );
  }
#endif
