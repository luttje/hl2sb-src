...
class CFmtStrN
{
 public:
  ...
  static inline int GetMaxLength()
  {
    return SIZE_BUF - 1;
  }
  ...
  void SetQuietTruncation( bool bQuiet )
  {
...
class CNumStr
{
 public:
  ...
  explicit CNumStr( ulint64 un64 )
  {
    SetUint64( ( uint64 )un64 );
  }
#endif
