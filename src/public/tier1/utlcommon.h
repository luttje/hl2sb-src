...
class CUtlKeyValuePair
{
 public:
  ...
  explicit CUtlKeyValuePair( const KInit &k )
      : m_key( k )
  {
  }

  template < typename KInit, typename VInit >
  CUtlKeyValuePair( const KInit &k, const VInit &v )
      : m_key( k ), m_value( v )
  {
  }
...
class CUtlKeyValuePair< K, empty_t >
{
 public:
  ...
  template < typename KInit >
  CUtlKeyValuePair( const KInit &k, empty_t )
      : m_key( k )
  {
  }

  CUtlKeyValuePair( const K &k, const empty_t & )
      : m_key( k ) {}
...
struct HasClassAltArgumentType
{
  ...
  enum
  {
    value = ( sizeof( Test< T >( NULL ) ) != sizeof( char ) )
  };
};
...
template <>
struct ArgumentTypeInfo< signed long long > : ArgumentTypeInfoImpl< signed long long >
{
};
template <>
struct ArgumentTypeInfo< unsigned long long > : ArgumentTypeInfoImpl< unsigned long long >
{
};
template <>
