...
class StringFuncs< char >
{
 public:
  ...
  static int Length( const char *pValue )
  {
  ...
  static const char *NullDebugString()
  {
    return "(null)";
  }
};
...
class StringFuncs< wchar_t >
{
 public:
  ...
  // Note that this function takes a character count, and does not guarantee null-termination.
  static void Copy( OUT_CAP( iLengthInChars ) wchar_t *out_pOut, const wchar_t *pIn, int iLengthInChars )
  {
  ...
  static int Length( const wchar_t *pValue )
  {
    return ( int )wcslen( pValue );
  }
  ...
  static const wchar_t *NullDebugString()
  {
    return L"(null)";
  }
};
...
class CUtlConstStringBase
{
 public:
  ...
  CUtlConstStringBase( const CUtlConstStringBase &src )
      : m_pString( NULL )
  {
    Set( src.m_pString );
  }
...
inline bool UtlStringCaseInsensitiveLessFunc( const CUtlString &lhs, const CUtlString &rhs )
{
