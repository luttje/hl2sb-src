...
#define DECLARE_CLASS_SIMPLE( className, baseClassName ) \
 ...
 public:                                                 \
  ...
  static char const *GetPanelBaseClassName()             \
  {                                                      \
...
#define MESSAGE_FUNC_CHARPTR( name, scriptname, p1 )                                 \
  _MessageFuncCommon( name, scriptname, 1, vgui::DATATYPE_CONSTCHARPTR, #p1, 0, 0 ); \
  virtual void name( const char *p1 )
#define MESSAGE_FUNC_WCHARPTR( name, scriptname, p1 )                                 \
  _MessageFuncCommon( name, scriptname, 1, vgui::DATATYPE_CONSTWCHARPTR, #p1, 0, 0 ); \
  virtual void name( const wchar_t *p1 )

// two parameters
#define MESSAGE_FUNC_INT_INT( name, scriptname, p1, p2 )                                       \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_INT, #p1, vgui::DATATYPE_INT, #p2 ); \
  virtual void name( int p1, int p2 )
#define MESSAGE_FUNC_PTR_INT( name, scriptname, p1, p2 )                                       \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_PTR, #p1, vgui::DATATYPE_INT, #p2 ); \
  virtual void name( vgui::Panel *p1, int p2 )
#define MESSAGE_FUNC_HANDLE_INT( name, scriptname, p1, p2 )                                       \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_HANDLE, #p1, vgui::DATATYPE_INT, #p2 ); \
...
#define MESSAGE_FUNC_INT_CHARPTR( name, scriptname, p1, p2 )                                            \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_INT, #p1, vgui::DATATYPE_CONSTCHARPTR, #p2 ); \
  virtual void name( int p1, const char *p2 )
#define MESSAGE_FUNC_PTR_CHARPTR( name, scriptname, p1, p2 )                                            \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_PTR, #p1, vgui::DATATYPE_CONSTCHARPTR, #p2 ); \
  virtual void name( vgui::Panel *p1, const char *p2 )
#define MESSAGE_FUNC_HANDLE_CHARPTR( name, scriptname, p1, p2 )                                            \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_HANDLE, #p1, vgui::DATATYPE_CONSTCHARPTR, #p2 ); \
  virtual void name( vgui::VPANEL p1, const char *p2 )
#define MESSAGE_FUNC_PTR_WCHARPTR( name, scriptname, p1, p2 )                                            \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_PTR, #p1, vgui::DATATYPE_CONSTWCHARPTR, #p2 ); \
  virtual void name( vgui::Panel *p1, const wchar_t *p2 )
#define MESSAGE_FUNC_HANDLE_WCHARPTR( name, scriptname, p1, p2 )                                            \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_HANDLE, #p1, vgui::DATATYPE_CONSTWCHARPTR, #p2 ); \
  virtual void name( vgui::VPANEL p1, const wchar_t *p2 )
#define MESSAGE_FUNC_CHARPTR_CHARPTR( name, scriptname, p1, p2 )                                                 \
  _MessageFuncCommon( name, scriptname, 2, vgui::DATATYPE_CONSTCHARPTR, #p1, vgui::DATATYPE_CONSTCHARPTR, #p2 ); \
...
#define MESSAGE_FUNC_PARAMS( name, scriptname, p1 )                                \
  _MessageFuncCommon( name, scriptname, 1, vgui::DATATYPE_KEYVALUES, NULL, 0, 0 ); \
...
#define MAP_MESSAGE_PARAMS( type, name, func )                                      \
  {                                                                                 \
    name, ( vgui::MessageFunc_t )( &type::func ), 1, vgui::DATATYPE_KEYVALUES, NULL \
  }
...
#define MAP_MESSAGE_FLOAT( type, name, func, param1 )                             \
  {                                                                               \
    name, ( vgui::MessageFunc_t )( &type::func ), 1, vgui::DATATYPE_FLOAT, param1 \
  }
#define MAP_MESSAGE_PTR( type, name, func, param1 )                             \
  {                                                                             \
    name, ( vgui::MessageFunc_t )( &type::func ), 1, vgui::DATATYPE_PTR, param1 \
...
#define MAP_MESSAGE_CONSTCHARPTR( type, name, func, param1 )                             \
  {                                                                                      \
    name, ( vgui::MessageFunc_t )( &type::func ), 1, vgui::DATATYPE_CONSTCHARPTR, param1 \
  }
#define MAP_MESSAGE_CONSTWCHARPTR( type, name, func, param1 )                             \
  {                                                                                       \
    name, ( vgui::MessageFunc_t )( &type::func ), 1, vgui::DATATYPE_CONSTWCHARPTR, param1 \
  }

// two parameters
#define MAP_MESSAGE_INT_INT( type, name, func, param1, param2 )                                           \
  {                                                                                                       \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_INT, param1, vgui::DATATYPE_INT, param2 \
  }
#define MAP_MESSAGE_PTR_INT( type, name, func, param1, param2 )                                           \
  {                                                                                                       \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_PTR, param1, vgui::DATATYPE_INT, param2 \
  }
#define MAP_MESSAGE_INT_CONSTCHARPTR( type, name, func, param1, param2 )                                           \
  {                                                                                                                \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_INT, param1, vgui::DATATYPE_CONSTCHARPTR, param2 \
  }
#define MAP_MESSAGE_PTR_CONSTCHARPTR( type, name, func, param1, param2 )                                           \
  {                                                                                                                \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_PTR, param1, vgui::DATATYPE_CONSTCHARPTR, param2 \
  }
#define MAP_MESSAGE_PTR_CONSTWCHARPTR( type, name, func, param1, param2 )                                           \
  {                                                                                                                 \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_PTR, param1, vgui::DATATYPE_CONSTWCHARPTR, param2 \
  }
#define MAP_MESSAGE_CONSTCHARPTR_CONSTCHARPTR( type, name, func, param1, param2 )                                           \
  {                                                                                                                         \
    name, ( vgui::MessageFunc_t ) & type::func, 2, vgui::DATATYPE_CONSTCHARPTR, param1, vgui::DATATYPE_CONSTCHARPTR, param2 \
  }
...
#define IMPLEMENT_PANELMAP( derivedClass, baseClass )                                                                                                         \
  ...
  vgui::PanelMap_t *derivedClass::GetPanelMap( void )                                                                                                         \
  {                                                                                                                                                           \
    return &m_PanelMap;                                                                                                                                       \
  }
