...
class HTML : public Panel
{
  ...
  */
  ...
  {
    return m_scrollHorizontal.m_nMax;
  }
  int VerticalScrollMax()
  {
    return m_scrollVertical.m_nMax;
  }
  ...
  {
    return m_SteamAPIContext.SteamHTMLSurface();
  }
 ...
 private:
  ...
  class CHTMLFindBar : public vgui::EditablePanel
  {
   ...
   public:
    ...
    {
      m_pFindBar->SetText( pchText );
    }
    void GetText( char *pText, int ccText )
    {
      m_pFindBar->GetText( pText, ccText );
    }
    void OnCommand( const char *pchCmd );
    void ShowCountLabel()
    {
      m_pFindCountLabel->SetVisible( true );
    }
    void HideCountLabel()
    {
      m_pFindCountLabel->SetVisible( false );
    }
    void SetHidden( bool bState )
    {
      m_bHidden = bState;
    }
    bool BIsHidden()
  ...
  {
    CustomCursorCache_t() {}
    CustomCursorCache_t( const void *pchData )
    {
      m_pchData = pchData;
    }
