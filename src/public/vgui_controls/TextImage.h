...
class TextImage : public Image
{
 ...
 public:
  ...
  void ClearColorChangeStream( void )
  {
    m_ColorChangeStream.Purge();
  }

  const wchar_t *GetEllipsesPosition( void ) const
  {
    return m_pwszEllipsesPosition;
  }
