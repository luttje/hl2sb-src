...
struct NetStartDialogFinished_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 6
  };
};
...
struct NetStartDialogUnloaded_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 7
  };
};
...
struct PS3SystemMenuClosed_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 8
  };
};
...
struct PS3NPMessageSelected_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 9
  };
  uint32 dataid;
};
...
struct PS3KeyboardDialogFinished_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 10
  };
};
...
struct PS3PSNStatusChange_t
{
  enum
  {
    k_iCallback = k_iSteamUtilsCallbacks + 12
  };
  bool m_bPSNOnline;
};
