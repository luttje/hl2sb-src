...
struct GSClientApprove_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 1
  };
...
struct GSClientDeny_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 2
  };
  CSteamID m_SteamID;
...
struct GSClientKick_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 3
  };
  CSteamID m_SteamID;
  EDenyReason m_eDenyReason;
};
...
struct GSClientAchievementStatus_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 6
  };
  uint64 m_SteamID;
...
struct GSGameplayStats_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 7
  };
...
struct GSClientGroupStatus_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 8
  };
...
struct GSReputation_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 9
  };
  EResult m_eResult;           // Result of the call;
...
struct AssociateWithClanResult_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 10
  };
  EResult m_eResult;  // Result of the call;
};
...
struct ComputeNewPlayerCompatibilityResult_t
{
  enum
  {
    k_iCallback = k_iSteamGameServerCallbacks + 11
  };
  EResult m_eResult;  // Result of the call;
