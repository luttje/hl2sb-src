...
#define DEFINE_CALLBACK( callbackname, callbackid ) \
  ...
  {                                                 \
    enum                                            \
    {                                               \
      k_iCallback = callbackid                      \
    };                                              \
    static callbackname *GetNullPointer()           \
    {                                               \
      return 0;                                     \
    }                                               \
    static const char *GetCallbackName()            \
    {                                               \
      return #callbackname;                         \
    }                                               \
    static uint32 GetCallbackID()                   \
    {                                               \
      return callbackname::k_iCallback;             \
    }
...
#define END_CALLBACK_INTERNAL_BEGIN( numvars )                                                                                                    \
  static uint32 GetNumMemberVariables()                                                                                                           \
  {                                                                                                                                               \
    return numvars;                                                                                                                               \
  }                                                                                                                                               \
