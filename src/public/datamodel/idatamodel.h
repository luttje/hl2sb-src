...
struct DmxHeader_t
{
  ...
  DmxHeader_t()
      : nEncodingVersion( -1 ), nFormatVersion( -1 )
  {
...
#define DEFINE_SOURCE_UNDO_SCOPE_GUARD( _classnameprefix, _source )                                                                                                                                                                        \
  ...
  {                                                                                                                                                                                                                                        \
   ...
   public:                                                                                                                                                                                                                                 \
    ...
    C##_classnameprefix##UndoScopeGuard( int nNotifyFlags, IDmNotify *pNotify, const char *pUndoDesc, const char *pRedoDesc = NULL, int nChainingID = 0 ) : BaseClass( _source, nNotifyFlags, pNotify, pUndoDesc, pRedoDesc, nChainingID ) \
    {                                                                                                                                                                                                                                      \
    }                                                                                                                                                                                                                                      \
    C##_classnameprefix##UndoScopeGuard( int nNotifyFlags, const char *pUndoDesc, int nChainingID ) : BaseClass( _source, nNotifyFlags, pUndoDesc, pUndoDesc, nChainingID )                                                                \
    {                                                                                                                                                                                                                                      \
    }                                                                                                                                                                                                                                      \
  };                                                                                                                                                                                                                                       \
