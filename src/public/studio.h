...
struct mstudioevent_t
{
  ...
  int event;
  int type;
  inline const char *pszOptions( void ) const
  {
    return options;
  }
  char options[64];
...
struct mstudioanim_t
{
  ...
  {
    return ( Vector48 * )( pData() + ( ( flags & STUDIO_ANIM_RAWROT ) != 0 ) * sizeof( *pQuat48() ) + ( ( flags & STUDIO_ANIM_RAWROT2 ) != 0 ) * sizeof( *pQuat64() ) );
  };
...
struct mstudioseqdesc_t
{
  ...
  inline mstudioactivitymodifier_t *pActivityModifier( int i ) const
  {
    ...
    return activitymodifierindex != 0 ? ( mstudioactivitymodifier_t * )( ( ( byte * )this ) + activitymodifierindex ) + i : NULL;
  };
...
struct mstudioflexcontrollerui_t
{
  ...
  {
    return remaptype == FLEXCONTROLLER_REMAP_NWAY ? pNWayValueController()->pszName() : NULL;
  }
  ...
  {
    return ( stereo ? 2 : 1 ) + ( remaptype == FLEXCONTROLLER_REMAP_NWAY ? 1 : 0 );
  }
...
struct mstudioflex_t
{
  ...
  inline byte *pBaseVertanim() const
  {
    return ( ( byte * )this ) + vertindex;
  };
  inline int VertAnimSizeBytes() const
  {
    return ( vertanimtype == STUDIO_VERT_ANIM_NORMAL ) ? sizeof( mstudiovertanim_t ) : sizeof( mstudiovertanim_wrinkle_t );
  }
...
struct studiohdr2_t
{
  ...
  {
    return ( linearboneindex ) ? ( mstudiolinearbone_t * )( ( ( byte * )this ) + linearboneindex ) : NULL;
  }
...
struct studiohdr_t
{
  ...
  inline mstudioflexcontroller_t *pFlexcontroller( LocalFlexController_t i ) const
  {
...
class CStudioHdr
{
 ...
 public:
  ...
  inline bool IsReadyForAccess( void ) const
  {
    return ( m_pStudioHdr != NULL );
  };
  inline virtualmodel_t *GetVirtualModel( void ) const
  {
    return m_pVModel;
  };
  inline const studiohdr_t *GetRenderHdr( void ) const
  {
    return m_pStudioHdr;
  };
 ...
 public:
  ...
  inline int numikchains() const
  {
    return m_pStudioHdr->numikchains;
  };
  inline int GetNumIKChains( void ) const
  {
    return m_pStudioHdr->numikchains;
  };
  inline mstudioikchain_t *pIKChain( int i ) const
  ...
  inline int numflexrules() const
  {
    return m_pStudioHdr->numflexrules;
  };
  inline mstudioflexrule_t *pFlexRule( int i ) const
  {
  ...
  inline int numflexdesc() const
  {
    return m_pStudioHdr->numflexdesc;
  };
  inline mstudioflexdesc_t *pFlexdesc( int i ) const
  {
  ...
  inline int numhitboxsets() const
  {
    return m_pStudioHdr->numhitboxsets;
  };
  ...
  inline int numbodyparts() const
  {
    return m_pStudioHdr->numbodyparts;
  };
  inline mstudiobodyparts_t *pBodypart( int i ) const
  {
  ...
  inline int numskinfamilies() const
  {
    return m_pStudioHdr->numskinfamilies;
  }

  inline Vector eyeposition() const
  {
  ...
  inline Vector illumposition() const
  {
  ...
  inline Vector view_bbmax() const
  {
    return m_pStudioHdr->view_bbmax;
  };

  inline int numtextures() const
  {
    return m_pStudioHdr->numtextures;
  };
...
struct flexsettinghdr_t
{
  ...
  {
    return ( char * )( ( ( byte * )this ) + *( ( int * )( ( ( byte * )this ) + keynameindex ) + i ) );
  };
  ...
  inline int LocalToGlobal( int i ) const
  {
    return *pLocalToGlobal( i );
  };
};
