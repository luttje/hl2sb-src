...
#define COMPUTE_GROUP( resgroup, dataptr )                                             \
  COMPUTE( resgroup##X, ( dataptr ), matSplat00, matSplat01, matSplat02, matSplat03 ); \
  COMPUTE( resgroup##Y, ( dataptr ), matSplat10, matSplat11, matSplat12, matSplat13 ); \
  COMPUTE( resgroup##Z, ( dataptr ), matSplat20, matSplat21, matSplat22, matSplat23 )
#define WRITE_GROUP( ptr, resgroup ) \
  ( ptr )->x = resgroup##X;          \
  ( ptr )->y = resgroup##Y;          \
  ( ptr )->z = resgroup##Z
  ...
  */
#define COMPUTE_STAGE1_ROW( res, tempvar, invec, xsplat, ysplat, zsplat, transplat ) \
  res = MulSIMD( ( invec )->y, ysplat );                                             \
  tempvar = MaddSIMD( ( invec )->z, zsplat, transplat )
...
#define COMPUTE_STAGE1_GROUP( resgroup, invec )                                                                \
  COMPUTE_STAGE1_ROW( resgroup##X, resgroup##X##Temp, invec, matSplat00, matSplat01, matSplat02, matSplat03 ); \
...
#define COMPUTE_STAGE2_GROUP( resgroup, invec )                                                                \
  COMPUTE_STAGE2_ROW( resgroup##X, resgroup##X##Temp, invec, matSplat00, matSplat01, matSplat02, matSplat03 ); \
...
#define COMPUTE_STAGE3_GROUP( resgroup, invec )                                                                \
  COMPUTE_STAGE3_ROW( resgroup##X, resgroup##X##Temp, invec, matSplat00, matSplat01, matSplat02, matSplat03 ); \
