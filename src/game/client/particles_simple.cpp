...
CSimpleEmitter::CSimpleEmitter( const char *pDebugName )
...
CEmberEffect::CEmberEffect( const char *pDebugName )
...
// Output : float
//-----------------------------------------------------------------------------
CFireSmokeEffect::CFireSmokeEffect( const char *pDebugName )
    : CSimpleEmitter( pDebugName )
{
}
...
// Output : Vector
//-----------------------------------------------------------------------------
CFireParticle::CFireParticle( const char *pDebugName )
    : CSimpleEmitter( pDebugName )
{
}
