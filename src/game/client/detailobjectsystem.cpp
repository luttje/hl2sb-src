...
class CDetailModel : public IClientUnknown, public IClientRenderable
{
 ...
 public:
  ...
  {
    return 0;
  }  // Static props DO implement this.
...
class CDetailObjectSystem : public IDetailObjectSystem, public ISpatialLeafEnumerator
{
 public:
  ...
  DetailPropLightstylesLump_t &DetailLighting( int i )
  {
    return m_DetailLighting[i];
  }
  DetailPropSpriteDict_t &DetailSpriteDict( int i )
  {
...
CDetailObjectSystem::CDetailObjectSystem()
    : m_DetailSpriteDict( 0, 32 ), m_DetailObjectDict( 0, 32 ), m_DetailSpriteDictFlipped( 0, 32 )
{
