...
class CHudCommentary : public CHudElement, public vgui::Panel
{
 ...
 public:
  ...
  bool IsTheActiveNode( C_PointCommentaryNode *pNode )
  {
    return ( pNode == m_hActiveNode );
  }
...
// Purpose:
//-----------------------------------------------------------------------------
CHudCommentary::CHudCommentary( const char *name )
    : vgui::Panel( NULL, "HudCommentary" ), CHudElement( name )
{
