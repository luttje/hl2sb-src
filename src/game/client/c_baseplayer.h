...
class C_BasePlayer : public C_BaseCombatCharacter, public CGameEventListener
{
 public:
  ...
  {
    return Hints() ? Hints()->HintMessage( hint, bForce, bOnlyIfClear ) : false;
  }
  ...
  bool ShouldAnnounceAchievement( void )
  {
    return m_flNextAchievementAnnounceTime < gpGlobals->curtime;
  }
  void SetNextAchievementAnnounceTime( float flTime )
  {
    m_flNextAchievementAnnounceTime = flTime;
  }
  ...
  bool HasFiredWeapon( void )
  {
    return m_bFiredWeapon;
  }
  void SetFiredWeapon( bool bFlag )
  {
    m_bFiredWeapon = bFlag;
  }

  virtual bool CanUseFirstPersonCommand( void )
  {
    return true;
  }
 ...
 protected:
  ...
  virtual float GetFallVelocity( void )
  {
 ...
 public:
  ...
  void SetOldPlayerZ( float flOld )
  {
    m_flOldPlayerZ = flOld;
  }
};
