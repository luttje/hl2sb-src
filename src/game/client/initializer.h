...
#define REGISTER_INITIALIZER( className, varPointer )            \
  static void *__Initializer__Create##className##Fn()            \
  {                                                              \
    return new className;                                        \
  }                                                              \
  static void *__Initializer__Delete##className##Fn( void *ptr ) \
  {                                                              \
...
#define REGISTER_FUNCTION_INITIALIZER( functionName )    \
  static void *__Initializer__Create##functionName##Fn() \
  {                                                      \
    functionName();                                      \
    return 0;                                            \
  }                                                      \
