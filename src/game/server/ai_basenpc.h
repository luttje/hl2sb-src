                    ...
                    public CAI_DefMovementSink
{
 ...
 public:
  ...
  virtual void PostscheduleThink( void )
  {
    return;
  };
 ...
 public:
  ...
  {
    return AI_IdIsLocal( globalScheduleID ) ? globalScheduleID : GetClassScheduleIdSpace()->ScheduleGlobalToLocal( globalScheduleID );
  }
  virtual int GetGlobalScheduleId( int localScheduleID )
  {
    return AI_IdIsGlobal( localScheduleID ) ? localScheduleID : GetClassScheduleIdSpace()->ScheduleLocalToGlobal( localScheduleID );
  }

  float GetTimeScheduleStarted() const
  {
    return m_ScheduleState.timeStarted;
  }
  ...
  void ClearTaskInterrupt()
  {
    m_ScheduleState.iTaskInterrupt = 0;
  }
  int GetTaskInterrupt() const
  {
    return m_ScheduleState.iTaskInterrupt;
  }
 ...
 private:
  ...
  void OnStartTask( void )
  {
    SetTaskStatus( TASKSTATUS_RUN_MOVE_AND_TASK );
  }
  void SetTaskStatus( TaskStatus_e status )
  {
    m_ScheduleState.fTaskStatus = status;
  }
  TaskStatus_e GetTaskStatus() const
  {
    return m_ScheduleState.fTaskStatus;
  }
 ...
 public:
  ...
  inline int LookupPoseMoveYaw()
  {
    return m_poseMove_Yaw;
  }
  ...
  virtual bool ShouldAcceptGoal( CAI_BehaviorBase *pBehavior, CAI_GoalEntity *pGoal )
  {
    return true;
  }
 ...
 public:
  ...
  bool ConditionsGathered() const
  {
    return m_bConditionsGathered;
  }
  const CAI_ScheduleBits &AccessConditionBits() const
  {
    return m_Conditions;
  }
 ...
 public:
  ...
  virtual bool ShouldGoToIdleState( void )
  {
    return ( false );
  }
  virtual void OnStateChange( NPC_STATE OldState, NPC_STATE NewState ){ /*Base class doesn't care*/ };

  NPC_STATE GetState( void )
  {
    return m_NPCState;
  }

  AI_Efficiency_t GetEfficiency() const
  {
    return m_Efficiency;
  }
  ...
  AI_MoveEfficiency_t GetMoveEfficiency() const
  {
    return m_MoveEfficiency;
  }
  ...
  AI_SleepState_t GetSleepState() const
  {
    return m_SleepState;
  }
  ...
  void AddSleepFlags( int flags )
  {
    m_SleepFlags |= flags;
  }
  void RemoveSleepFlags( int flags )
  {
    m_SleepFlags &= ~flags;
  }
  bool HasSleepFlags( int flags )
  {
    return ( m_SleepFlags & flags ) == flags;
  }
 ...
 public:
  ...
  {
    return 0;
  }  // Enemy distances within this tolerance of each other are considered equivalent.
  ...
  void SetDeathPose( const int &iDeathPose )
  {
    m_iDeathPose = iDeathPose;
  }
 ...
 private:
  ...
  {
    return NULL;
  }  // OBSOLETE, replaced by GatherEnemyConditions(), left here to make derived code not compile
 ...
 public:
  ...
  virtual bool IsCommandMoving()
  {
    return false;
  }
  virtual bool ShouldAutoSummon()
  {
    return false;
  }
  ...
  const Vector &GetCommandGoal() const
  {
 ...
 protected:
  ...
  {
    return ( m_iInteractionState == NPCINT_RUNNING_ACTIVE && ( m_hCine != NULL ) );
  }
 ...
 public:
  ...
  const CAI_Navigator *GetNavigator() const
  {
    return m_pNavigator;
  }

  CAI_LocalNavigator *GetLocalNavigator()
  {
  ...
  const CAI_MoveProbe *GetMoveProbe() const
  {
    return m_pMoveProbe;
  }
  ...
  void SetUpdatedYaw()
  {
    m_ScheduleState.bTaskUpdatedYaw = true;
  }
  ...
  virtual bool IsValidMoveAwayDest( const Vector &vecDest )
  {
    return true;
  }
 ...
 public:
  ...
  virtual CBaseEntity *GetAlternateMoveShootTarget()
  {
    return NULL;
  }
 ...
 public:
  ...
  //-----------------------------------------------------
  inline bool IsInAScript( void )
  {
    return m_bInAScript;
  }
  inline void SetInAScript( bool bScript )
  {
    m_bInAScript = bScript;
  }
  ...
  void InputGagEnable( inputdata_t &inputdata )
  {
 ...
 public:
  ...
  bool IsInLockedScene( void )
  {
    return m_flSceneTime > gpGlobals->curtime;
  };
  float m_flSceneTime;
 ...
 public:
  ...
  float GetLastPlayerDamageTime() const
  {
    return m_flLastPlayerDamageTime;
  }
  float GetLastEnemyTime() const
  {
    return m_flLastEnemyTime;
  }
  ...
  inline CAI_ShotRegulator *GetShotRegulator()
  {
    return &m_ShotRegulator;
  }
 ...
 public:
  ...
  void CheckSquad();
  void SetSquadName( string_t name )
  {
    m_SquadName = name;
  }
  ...
  string_t GetHintGroup( void )
  {
    return m_strHintGroup;
  }
  void ClearHintGroup( void )
  {
    SetHintGroup( NULL_STRING );
  }
  void SetHintGroup( string_t name, bool bHintGroupNavLimiting = false );
  bool IsLimitingHintGroups( void )
  {
    return m_bHintGroupNavLimiting;
  }
  ...
  virtual float CoverRadius( void )
  {
    return 1024;
  }  // Default cover radius
 ...
 public:
  ...
  virtual bool CurrentWeaponLOSCondition( const Vector &targetPos, bool bSetConditions )
  {
  ...
  {
    return BodyTarget( vec3_origin, false );
  }
  ...
  const CAI_Hint *GetHintNode() const
  {
    return m_pHintNode;
  }
 ...
 public:
  ...
  {
    return NAI_Hull::Width( GetHullType() );
  }
  float GetHullHeight() const
  {
    return NAI_Hull::Height( GetHullType() );
  }
 ...
 protected:
  ...
  virtual Vector GetCrouchGunOffset( void )
  {
 ...
 public:
  ...
  bool IsNavigationDeferred( void )
  {
    return m_bDeferredNavigation;
  }
...
class CPostFrameNavigationHook : public CBaseGameSystemPerFrame
{
 public:
  ...
  bool IsGameFrameRunning( void )
  {
    return m_bGameFrameRunning;
  }
  void SetGrameFrameRunning( bool bState )
  {
    m_bGameFrameRunning = bState;
  }
