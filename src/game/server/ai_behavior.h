...
abstract_class CAI_BehaviorBase : public CAI_Component
{
 ...
 public:
  ...
  void BridgeUpdateOnRemove()
  {
    UpdateOnRemove();
  }
  void BridgeEvent_Killed( const CTakeDamageInfo &info )
  {
    Event_Killed( info );
  }
  ...
  void BridgeGatherConditions()
  {
    GatherConditions();
  }
  void BridgePrescheduleThink()
  {
    PrescheduleThink();
  }
  void BridgeOnScheduleChange()
  {
    OnScheduleChange();
  }
  ...
  void BridgeBuildScheduleTestBits()
  {
    BuildScheduleTestBits();
  }
  bool BridgeIsCurTaskContinuousMove( bool *pResult );
  void BridgeOnMovementFailed()
  {
    OnMovementFailed();
  }
  void BridgeOnMovementComplete()
  {
    OnMovementComplete();
  }
  ...
  {
    return;
  }  // Override this and your behavior will call this in place of GatherConditions() when your behavior is NOT the active one.
 ...
 protected:
  ...
  string_t GetHintGroup()
  {
    return GetOuter()->GetHintGroup();
  }
  void ClearHintGroup()
  {
    GetOuter()->ClearHintGroup();
  }
  void SetHintGroup( string_t name )
  {
    GetOuter()->SetHintGroup( name );
  }
