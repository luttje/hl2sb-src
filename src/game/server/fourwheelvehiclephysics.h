...
class CFourWheelVehiclePhysics
{
 public:
  ...
  bool IsEngineDisabled( void )
  {
    return m_pVehicle->IsEngineDisabled();
  }
  ...
  IPhysicsObject *GetWheel( int iWheel )
  {
    return m_pWheels[iWheel];
  }
  ...
  IPhysicsVehicleController *GetVehicle( void )
  {
    return m_pVehicle;
  }
