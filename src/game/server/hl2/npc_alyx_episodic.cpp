...
template <>
CNPC_Alyx *CEntityClassList< CNPC_Alyx >::m_pClassList = NULL;
...
Activity CNPC_Alyx::NPC_TranslateActivity( Activity activity )
{
  ...
  switch ( activity )
  {
    ...
    case ACT_PICKUP_RACK:
      return ( Activity )ACT_ALYX_PICKUP_RACK;
    case ACT_DROP_WEAPON:
      if ( HasShotgun() ) return ( Activity )ACT_DROP_WEAPON_SHOTGUN;
  }
