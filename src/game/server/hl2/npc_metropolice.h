...
class CNPC_MetroPolice : public CAI_BaseActor
{
 ...
 public:
  ...
  Vector EyeDirection3D( void )
  {
    return CAI_BaseHumanoid::EyeDirection3D();
  }  // cops don't have eyes
  ...
  bool ShouldBruteForceFailedNav()
  {
    return false;
  }
  ...
  CAI_Sentence< CNPC_MetroPolice > *GetSentences()
  {
    return &m_Sentences;
  }
