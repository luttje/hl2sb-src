...
const char *CBreakable::pSpawnObjects[] =
    {
        ...
        "unused (???"
        ") 15",                    // 15 - split into two strings to avoid trigraph warning
        "weapon_stunstick",        // 16
        "unused (weapon_ar1) 17",  // 17
        "weapon_ar2",              // 18
        "unused (???"
        ") 19",                        // 19 - split into two strings to avoid trigraph warning
        "weapon_rpg",                  // 20
        "weapon_smg1",                 // 21
...
class CPushable : public CBreakable
{
 public:
  ...
  {
    return BaseClass::ObjectCaps() | FCAP_ONOFF_USE;
  }
