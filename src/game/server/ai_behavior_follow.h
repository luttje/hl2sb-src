...
class CAI_FollowBehavior : public CAI_SimpleBehavior
{
 ...
 public:
  ...
  AI_Formations_t GetFormation() const
  {
    return m_params.formation;
  }
  ...
  CAI_FollowGoal *GetFollowGoal()
  {
    return m_hFollowGoalEnt;
  }  // if any
  ...
  virtual bool FarFromFollowTarget()
  {
    return ( m_hFollowTarget && ( GetAbsOrigin() - m_hFollowTarget->GetAbsOrigin() ).LengthSqr() > ( 75 * 12 ) * ( 75 * 12 ) );
  }

  virtual bool TargetIsUnreachable()
  {
    return m_bTargetUnreachable;
  }

  int GetNumFailedFollowAttempts()
  {
    return m_nFailedFollowAttempts;
  }
  float GetTimeFailFollowStarted()
  {
    return m_flTimeFailFollowStarted;
  }
  bool FollowTargetVisible()
  {
    return HasCondition( COND_FOLLOW_TARGET_VISIBLE );
  };
 ...
 protected:
  ...
  virtual int FollowCallBaseSelectSchedule()
  {
