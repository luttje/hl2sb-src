...
class CBreakable : public CBaseEntity, public IBreakableWithPropData, public CDefaultPlayerPickupVPhysics
{
 public:
  ...
  {
    return GetExplosiveRadius() > 0;
  }

  Materials GetMaterialType( void )
  {
    return m_Material;
  }
 ...
 public:
  ...
  void SetPropDataIsAIWalkable( bool bBlocksLOS )
  {
    SetAIWalkable( bBlocksLOS );
  }
