...
const char* CAI_BaseNPC::GetSquadSlotDebugName( int iSquadSlot )
{
  switch ( iSquadSlot )
  {
    case SQUAD_SLOT_NONE:
      return "None";
      break;
    case SQUAD_SLOT_ATTACK1:
      return "SQUAD_SLOT_ATTACK1";
      break;
    case SQUAD_SLOT_ATTACK2:
      return "SQUAD_SLOT_ATTACK2";
      break;
    case SQUAD_SLOT_INVESTIGATE_SOUND:
      return "SQUAD_SLOT_INVESTIGATE_SOUND";
      break;
    case SQUAD_SLOT_EXCLUSIVE_HANDSIGN:
      return "SQUAD_SLOT_EXCLUSIVE_HANDSIGN";
      break;
    case SQUAD_SLOT_EXCLUSIVE_RELOAD:
      return "SQUAD_SLOT_EXCLUSIVE_RELOAD";
      break;
    case SQUAD_SLOT_PICKUP_WEAPON1:
      return "SQUAD_SLOT_PICKUP_WEAPON1";
      break;
    case SQUAD_SLOT_PICKUP_WEAPON2:
      return "SQUAD_SLOT_PICKUP_WEAPON2";
      break;
    case SQUAD_SLOT_SPECIAL_ATTACK:
