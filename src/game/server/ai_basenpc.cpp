  ...
  while ( pCurrentSound )
  {
    ...
    if ( pCurrentSound->FIsSound() )
    {
      ...
      switch ( pCurrentSound->SoundTypeNoContext() )
      {
        ...
        case SOUND_THUMPER:
          condition = COND_HEAR_THUMPER;
          break;
        case SOUND_BUGBAIT:
          condition = COND_HEAR_BUGBAIT;
          break;
        case SOUND_COMBAT:
        ...
        case SOUND_WORLD:
          condition = COND_HEAR_WORLD;
          break;
        case SOUND_PLAYER:
          condition = COND_HEAR_PLAYER;
          break;
        case SOUND_BULLET_IMPACT:
          condition = COND_HEAR_BULLET_IMPACT;
          break;
        case SOUND_PHYSICS_DANGER:
          condition = COND_HEAR_PHYSICS_DANGER;
          break;
        case SOUND_DANGER_SNIPERONLY: /* silence warning */
          break;
        case SOUND_MOVE_AWAY:
          condition = COND_HEAR_MOVE_AWAY;
          break;
...
{
  return ( m_NPCState == NPC_STATE_ALERT || m_NPCState == NPC_STATE_COMBAT ) ? ai_reaction_delay_alert.GetFloat() : ai_reaction_delay_idle.GetFloat();
}
