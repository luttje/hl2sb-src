...
#define DebugNoteMovementFailureIfBlocked( moveResult ) \
...
#else
inline AIMoveResult_t DbgResult( AIMoveResult_t result )
{
  return result;
}  // inline not macro for compiler typing
#endif
