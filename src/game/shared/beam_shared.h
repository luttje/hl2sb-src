...
class CBeam : public CBaseEntity
{
 ...
 public:
  ...
  void SetMinDXLevel( int nMinDXLevel )
  {
    m_nMinDXLevel = nMinDXLevel;
  }
  ...
  void SetHDRColorScale( float flScale )
  {
    m_flHDRColorScale = flScale;
  }
...
// Only supported in TF2 right now
  ...
  virtual const char *GetDecalName( void )
  {
    return "BigShot";
  }
