...
class CTeamplayRoundBasedRules : public CTeamplayRules, public CGameEventListener
{
 ...
 public:
  ...
  // Data accessors
  inline gamerules_roundstate_t State_Get( void )
  {
    return m_iRoundState;
  }
  bool IsInWaitingForPlayers( void )
  {
  ...
  bool InStalemate( void )
  {
    return State_Get() == GR_STATE_STALEMATE;
  }
  bool RoundHasBeenWon( void )
  {
  ...
  {
    return ( ( State_Get() == GR_STATE_RND_RUNNING || State_Get() == GR_STATE_STALEMATE ) && !IsInWaitingForPlayers() );
  }
  virtual void SetLastCapPointChanged( int iIndex )
  {
    m_iLastCapPointChanged = iIndex;
  }
  int GetLastCapPointChanged( void )
  {
    return m_iLastCapPointChanged;
  }
  ...
  bool InOvertime( void )
  {
    return m_bInOvertime;
  }
  ...
  bool SwitchedTeamsThisRound( void )
  {
  ...
  bool IsWaitingForTeams( void )
  {
    return m_bAwaitingReadyRestart;
  }
  bool IsInStopWatch( void )
  {
    return m_bStopWatch;
  }
  void SetInStopWatch( bool bState )
  {
    m_bStopWatch = bState;
  }
  ...
  float GetRoundRestartTime( void )
  {
    return m_flRestartRoundTime;
  }

  // Arena Mode
  virtual bool IsInArenaMode( void )
  {
    return false;
  }

  // Koth Mode
  virtual bool IsInKothMode( void )
  {
    return false;
  }

  // Training Mode
  virtual bool IsInTraining( void )
  {
    return false;
  }
 ...
 public:
  ...
  virtual bool ShouldScorePerRound( void )
  {
    return true;
  }
  ...
  virtual bool TournamentModeCanEndWithTimelimit( void )
  {
    return true;
  }
 ...
 public:
  ...
  string_t GetRoundToPlayNext( void )
  {
    return m_iszRoundToPlayNext;
  }
  ...
  string_t GetFirstRoundPlayed()
  {
    return m_iszFirstRoundPlayed;
  }
  ...
  int GetRoundsPlayed( void )
  {
    return m_nRoundsPlayed;
  }
 ...
 protected:
  ...
  virtual bool AllowWaitingForPlayers( void )
  {
    return true;
  }
