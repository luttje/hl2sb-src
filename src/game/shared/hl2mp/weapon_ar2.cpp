...
void CWeaponAR2::DelayedAttack( void )
{
  ...
  m_flNextSecondaryAttack = pOwner->m_flNextAttack =
  ...
  CreateCombineBall( vecSrc, vecVelocity,
                     sk_weapon_ar2_alt_fire_radius.GetFloat(),
                     sk_weapon_ar2_alt_fire_mass.GetFloat(),
                     sk_weapon_ar2_alt_fire_duration.GetFloat(), pOwner );
...
void CWeaponAR2::SecondaryAttack( void )
{
  ...
  m_bShotDelayed = true;
  m_flNextPrimaryAttack = m_flNextSecondaryAttack = m_flDelayedFire =
...
#define SLIDE_LIMIT 5.0f        // Seconds
  ...
  DoMachineGunKick( pPlayer, EASY_DAMPEN, MAX_VERTICAL_KICK, m_fFireDuration,
                    SLIDE_LIMIT );
}
