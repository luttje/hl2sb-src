...
class CAchievementMgr : public CAutoGameSystemPerFrame, public CGameEventListener, public IAchievementMgr
{
 public:
  ...
  float GetLastClassChangeTime()
  {
    return m_flLastClassChangeTime;
  }
  float GetTeamplayStartTime()
  {
    return m_flTeamplayStartTime;
  }
  int GetMiniroundsCompleted()
  {
    return m_iMiniroundsCompleted;
  }
  ...
  bool WereCheatsEverOn( void )
  {
    return m_bCheatsEverOn;
  }
