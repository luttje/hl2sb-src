...
class CTakeDamageInfo
{
 public:
  ...
  void SetForceFriendlyFire( bool bValue )
  {
    m_bForceFriendlyFire = bValue;
  }
  bool IsForceFriendlyFire( void ) const
  {
    return m_bForceFriendlyFire;
  }
  ...
  int GetPlayerPenetrationCount() const
  {
