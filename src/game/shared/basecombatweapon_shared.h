...
class CBaseCombatWeapon : public BASECOMBATWEAPON_DERIVED_FROM
{
 public:
  ...
  virtual bool IsBaseCombatWeapon( void ) const
  {
    return true;
  }
  virtual CBaseCombatWeapon *MyCombatWeaponPointer( void )
  {
    return this;
  }
  ...
  {
    return true;
  }                             // return true if the weapon's allowed to deploy
  ...
  {
    return false;
  }  // Is this weapon in its 'zoomed in' mode?
  ...
  {
    return random->RandomInt( GetMinBurst(), GetMaxBurst() );
  }
  ...
  // Autoaim
  virtual float GetMaxAutoAimDeflection()
  {
    return 0.99f;
  }
  ...
  virtual bool StopSprinting( void )
  {
    return false;
  };
 ...
 public:
  ...
  {
    m_iPrimaryAmmoCount = count;
  }

  int GetSecondaryAmmoCount()
  {
    return m_iSecondaryAmmoCount;
  }
  void SetSecondaryAmmoCount( int count )
  {
    m_iSecondaryAmmoCount = count;
  }
  ...
  virtual bool ShouldUseLargeViewModelVROverride()
  {
    return false;
  }
...
// Client only methods
  ...
  virtual bool AddLookShift( void )
  {
    return true;
  };
 ...
 protected:
  ...
  void RemoveFromCritBucket( float flAmount )
  {
