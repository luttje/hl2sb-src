...
{
  luaL_checkangle( L, 1 ).Init( luaL_optnumber( L, 1, 0.000000 ), luaL_optnumber( L, 1, 0.000000 ), luaL_optnumber( L, 1, 0.000000 ) );
  return 0;
}
...
{
  lua_pushfstring( L, "QAngle: %s", VecToString( luaL_checkangle( L, 1 ) ) );
  return 1;
}
