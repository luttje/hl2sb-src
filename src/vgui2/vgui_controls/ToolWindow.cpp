...
void ToolWindow::Grow( int edge, int from_x, int from_y )
{
  ...
  if ( ( edge == 0 ) || ( edge == 1 ) )
  {
    ...
    for ( int i = 0; i < c; ++i )
    {
      ...
      // grow it
      if ( ( ( ( old_x > x ) && ( old_x < x + w ) ) || ( ( old_x + old_w > x ) && ( old_x + old_w < x + w ) ) || ( ( old_x <= x ) && old_x + old_w >= x + w ) ) && ( ( old_y >= y + h ) && ( new_y < y + h ) ) )
      {
  ...
  if ( ( edge == 0 ) || ( edge == 2 ) )
  {
    ...
    for ( int i = 0; i < c; ++i )
    {
      ...
      // grow it
      if ( ( ( ( old_y > y ) && ( old_y < y + h ) ) || ( ( old_y + old_h > y ) && ( old_y + old_h < y + h ) ) || ( ( old_y <= y ) && old_y + old_h >= y + h ) ) && ( ( old_x + old_w <= x ) && ( new_w > x - old_x ) ) )
      {
        new_w = x - old_x;
      }
    }
  ...
  if ( ( edge == 0 ) || ( edge == 3 ) )
  {
    ...
    for ( int i = 0; i < c; ++i )
    {
      ...
      // grow it
      if ( ( ( ( old_x > x ) && ( old_x < x + w ) ) || ( ( old_x + old_w > x ) && ( old_x + old_w < x + w ) ) || ( ( old_x <= x ) && old_x + old_w >= x + w ) ) && ( ( old_y + old_h <= y ) && ( new_h > y - old_y ) ) )
      {
        new_h = y - old_y;
      }
    }
  ...
  if ( ( edge == 0 ) || ( edge == 4 ) )
  {
    ...
    for ( int i = 0; i < c; ++i )
    {
      ...
      // grow it
      if ( ( ( ( old_y > y ) && ( old_y < y + h ) ) || ( ( old_y + old_h > y ) && ( old_y + old_h < y + h ) ) || ( ( old_y <= y ) && old_y + old_h >= y + h ) ) && ( ( old_x >= x + w ) && ( new_x < x + w ) ) )
      {
