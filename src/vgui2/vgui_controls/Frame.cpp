...
class FrameButton : public Button
{
 ...
 public:
  ...
  FrameButton( Panel *parent, const char *name, const char *text )
      : Button( parent, name, text )
  {
...
class FrameSystemButton : public MenuButton
{
 ...
 public:
  ...
  virtual void ApplySchemeSettings( IScheme *pScheme )
  {
    ...
    const char *pEnabledImage = m_EnabledImage.Length() ? m_EnabledImage.Get() : pScheme->GetResourceString( "FrameSystemButton.Icon" );
    const char *pDisabledImage = m_DisabledImage.Length() ? m_DisabledImage.Get() : pScheme->GetResourceString( "FrameSystemButton.DisabledIcon" );
