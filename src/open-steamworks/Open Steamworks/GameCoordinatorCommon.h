...
struct GCMessageFailed_t
{
  enum
  {
    k_iCallback = k_iSteamGameCoordinatorCallbacks + 2
  };
};
#pragma pack( pop )
...
struct SOMsgCacheUnsubscribed_t
{
  enum
  {
    k_iMessage = k_ESOMsg_CacheUnsubscribed
  };
  GCMsgHeader_t header;
...
struct GCSetItemPosition_t
{
  enum
  {
    k_iMessage = k_EMsgGCSetItemPosition
  };
  GCMsgHeader_t header;
...
struct GCCraftResponse_t
{
  enum
  {
    k_iMessage = k_EMsgGCCraftResponse
  };
  GCMsgHeader_t header;
...
struct GCVerifyCacheSubscription_t
{
  enum
  {
    k_iMessage = k_EMsgGCVerifyCacheSubscription
  };
  GCMsgHeader_t header;
...
struct GCGoldenWrenchBroadcast_t
{
  enum
  {
    k_iMessage = k_EMsgGCGoldenWrenchBroadcast
  };
  GCMsgHeader_t header;
...
struct GCMOTDRequest_t
{
  enum
  {
    k_iMessage = k_EMsgGCMOTDRequest
  };
  GCMsgHeader_t header;
...
struct GCMOTDRequestResponse_t
{
  enum
  {
    k_iMessage = k_EMsgGCMOTDRequestResponse
  };
  GCMsgHeader_t header;
...
struct GC_GameServer_AuthChallenge_t
{
  enum
  {
    k_iMessage = k_EMsgGC_GameServer_AuthChallenge
  };
  GCMsgHeader_t header;
...
struct GC_GameServer_AuthChallengeResponse_t
{
  enum
  {
    k_iMessage = k_EMsgGC_GameServer_AuthChallengeResponse
  };
  GCMsgHeader_t header;
...
struct GC_GameServer_LevelInfo_t
{
  enum
  {
    k_iMessage = k_EMsgGC_GameServer_LevelInfo
  };
  GCMsgHeader_t header;
...
struct GCTrading_InitiateTradeRequest_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_InitiateTradeRequest
  };
  GCMsgHeader_t header;
...
struct GCTrading_InitiateTradeResponse_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_InitiateTradeResponse
  };
  GCMsgHeader_t header;
...
struct GCTrading_TradeChatMsg_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_TradeChatMsg
  };
  GCMsgHeader_t header;
...
struct GCTrading_TradeTypingChatMsg_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_TradeTypingChatMsg
  };
  GCMsgHeader_t header;
};
...
struct GCTrading_StartSession_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_StartSession
  };
  GCMsgHeader_t header;
...
struct GCTrading_SetItem_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_SetItem
  };
  GCMsgHeader_t header;
...
struct GCTrading_RemoveItem_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_RemoveItem
  };
  GCMsgHeader_t header;
...
struct GCTrading_UpdateTradeInfo_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_UpdateTradeInfo
  };
  GCMsgHeader_t header;
...
struct GCTrading_ReadinessResponse_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_ReadinessResponse
  };
  GCMsgHeader_t header;
...
struct GCTrading_SetReadiness_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_SetReadiness
  };
  GCMsgHeader_t header;
...
struct GCTrading_ConfirmOffer_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_ConfirmOffer
  };
  GCMsgHeader_t header;
...
struct GCTrading_SessionClosed_t
{
  enum
  {
    k_iMessage = k_EMsgGCTrading_SessionClosed
  };
  GCMsgHeader_t header;
...
struct GCRespawnPostLoadoutChange_t
{
  enum
  {
    k_iMessage = k_EMsgGCRespawnPostLoadoutChange
  };
  GCMsgHeader_t header;
