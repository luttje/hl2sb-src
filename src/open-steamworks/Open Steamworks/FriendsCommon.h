...
struct FriendAdded_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 1
  };
...
struct UserRequestingFriendship_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 2
  };
...
struct PersonaStateChangeOld_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 3
  };
...
struct SystemIM_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 5
  };
...
struct FriendChatMsg_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 6
  };
...
struct FriendInvited_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 7
  };
...
struct ChatRoomInvite_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 8
  };
...
struct ChatRoomEnter_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 9
  };
...
struct ChatMemberStateChange_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 10
  };
...
struct ChatRoomMsg_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 11
  };
...
struct ChatRoomDlgClose_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 12
  };
...
struct ChatRoomClosing_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 13
  };
...
struct ChatRoomKicking_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 14
  };
...
struct ChatRoomBanning_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 15
  };
...
struct ChatRoomCreate_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 16
  };
...
struct ChatRoomMetadataUpdate_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 17
  };
...
struct OpenChatDialog_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 18
  };
...
struct ChatRoomActionResult_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 19
  };
...
struct ChatRoomDlgSerialized_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 20
  };
...
struct ClanInfoChanged_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 21
  };
...
struct ChatMemberInfoChanged_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 22
  };
...
struct ChatRoomInfoChanged_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 23
  };
...
struct ChatRoomSpeakChanged_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 25
  };
...
struct NotifyIncomingCall_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 26
  };
...
struct NotifyHangup_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 27
  };
...
struct NotifyRequestResume_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 28
  };
...
struct NotifyChatRoomVoiceStateChanged_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 29
  };
...
struct ChatRoomDlgUIChange_t
{
  enum
  {
    k_iCallback = k_iSteamFriendsCallbacks + 30
  };
...
struct FriendProfileInfoReceived_t
{
  enum
  {
    k_iCallback = k_iClientFriendsCallbacks + 38
  };
