...
class CCallbackManual : public CCallback< T, P, bGameServer >
{
 public:
  CCallbackManual()
      : CCallback< T, P, bGameServer >( NULL, NULL ) {}
};
...
#define STEAM_CALLBACK( thisclass, func, param, var ) \
  CCallback< thisclass, param, false > var;           \
...
#define STEAM_CALLBACK_MANUAL( thisclass, func, param, var ) \
  CCallbackManual< thisclass, param, false > var;            \
  void func( param *pParam )
