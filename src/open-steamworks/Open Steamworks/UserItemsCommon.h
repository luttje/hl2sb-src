...
struct UserItemCount_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks
  };
  CGameID m_gameID;
...
struct UserItemMoved_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks + 1
  };
...
struct UserItemDeleted_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks + 2
  };
...
struct UserItemGranted_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks + 3
  };
...
struct UserItemGetBlob_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks + 4
  };
...
struct UserItemSetBlob_t
{
  enum
  {
    k_iCallback = k_iSteamUserItemsCallbacks + 5
  };
