...
abstract_class ISteam005
{
 public:
  ...
  virtual int MountFilesystem( unsigned int uAppId, const char* szMountPath, TSteamError* pError ) = 0;
  virtual int UnmountFilesystem( unsigned int uAppId, TSteamError* pError ) = 0;
  ...
  virtual SteamHandle_t OpenFileEx( const char* cszFileName, const char* cszMode, unsigned int* puSize, TSteamError* pError ) = 0;
  ...
  virtual int SeekFile( SteamHandle_t hFile, long lOffset, ESteamSeekMethod sm, TSteamError* pError ) = 0;
  ...
  virtual int NumAppsRunning( TSteamError * pError ) = 0;
  ...
  virtual int EnumerateAppDependency( unsigned int AppId, unsigned int uDependency, TSteamAppDependencyInfo* pDependencyInfo, TSteamError* pError ) = 0;
  ...
  virtual int GetAppPurchaseCountry( unsigned int uAppId, char* szCountryCode, unsigned int uBufferLength, unsigned int* puRecievedLength, TSteamError* pError ) = 0;

  // ISteam005
  virtual int GetLocalClientVersion( unsigned int* puArg1, unsigned int* puArg2, TSteamError* pError ) = 0;
  virtual int IsFileNeededByCache( unsigned int uArg1, const char* cszFileName, unsigned int uArg3, TSteamError* pError ) = 0;
